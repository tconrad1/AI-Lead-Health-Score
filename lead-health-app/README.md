...
This MVP presents a simple lead prioritization experience for the exercise brief. It loads sample lead data from the server, scores each lead using a lightweight rule-based approach, and shows the reasoning plus a tailored next action for the selected lead. Built with node and vite.
...
## Run locally
1. Enter into the lead-health-app folde
   cd lead-health-app
